...
(cl:defmethod cl:initialize-instance :after ((m <CtrlCmd>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CtrlCmd)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name Tracking_pkg-msg:<CtrlCmd> is deprecated: use Tracking_pkg-msg:CtrlCmd instead.")))

(cl:ensure-generic-function 'longlCmdType-val :lambda-list '(m))
(cl:defmethod longlCmdType-val ((m <CtrlCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Tracking_pkg-msg:longlCmdType-val is deprecated.  Use Tracking_pkg-msg:longlCmdType instead.")
  (longlCmdType m))

(cl:ensure-generic-function 'accel-val :lambda-list '(m))
(cl:defmethod accel-val ((m <CtrlCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Tracking_pkg-msg:accel-val is deprecated.  Use Tracking_pkg-msg:accel instead.")
  (accel m))

(cl:ensure-generic-function 'brake-val :lambda-list '(m))
(cl:defmethod brake-val ((m <CtrlCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Tracking_pkg-msg:brake-val is deprecated.  Use Tracking_pkg-msg:brake instead.")
  (brake m))

(cl:ensure-generic-function 'steering-val :lambda-list '(m))
(cl:defmethod steering-val ((m <CtrlCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Tracking_pkg-msg:steering-val is deprecated.  Use Tracking_pkg-msg:steering instead.")
  (steering m))

(cl:ensure-generic-function 'velocity-val :lambda-list '(m))
(cl:defmethod velocity-val ((m <CtrlCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Tracking_pkg-msg:velocity-val is deprecated.  Use Tracking_pkg-msg:velocity instead.")
  (velocity m))

(cl:ensure-generic-function 'acceleration-val :lambda-list '(m))
(cl:defmethod acceleration-val ((m <CtrlCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Tracking_pkg-msg:acceleration-val is deprecated.  Use Tracking_pkg-msg:acceleration instead.")
  (acceleration m))
