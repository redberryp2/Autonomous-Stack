...
class fusInfo {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.int32(obj.classes, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new fusInfo(null);
    // Deserialize message field [classes]
    data.classes = _deserializer.int32(buffer, bufferOffset);
  ...
  static Resolve(msg) {
    ...
    const resolved = new fusInfo(null);
