...
"""autogenerated by genpy from plnctrl/fusInfo.msg. Do not edit."""
import codecs
import sys
...
class fusInfo(genpy.Message):
  _md5sum = "60517df6681971a7511b4a41ebdc61e5"
  _type = "plnctrl/fusInfo"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """int32           classes
float32         posX
float32         posY
float32         posZ
float32         size
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(fusInfo, self).__init__(*args, **kwds)
